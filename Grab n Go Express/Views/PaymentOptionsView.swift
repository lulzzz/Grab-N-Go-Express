...
class PaymentOptionsView: UIController {
    ...
    override func viewDidLoad() {
        ...
        let fancyTextFive = FancyTextControl(frame: CGRect(x: 0, y: 0, width: addFiveButton.frame.width, height: addFiveButton.frame.height))
        ...
        fancyTextFive.isUserInteractionEnabled = false
        ...
        let fancyTextTen = FancyTextControl(frame: CGRect(x: 0, y: 0, width: addFiveButton.frame.width, height: addFiveButton.frame.height))
        xPos = 130
        ...
        fancyTextTen.isUserInteractionEnabled = false
        ...
        //let amountDue: String = formatter.string(from: NSNumber(cartTotalDisplay))!
        let amountDue: String = formatter.string(from: NSNumber( value: cartTotalDisplay))!
        print(amountDue)

        print(amountDue)
        let fancyTextChargeExact = FancyTextControl(frame: CGRect(x: 0, y: 0, width: addFiveButton.frame.width, height: addFiveButton.frame.height))
        ...
        fancyTextChargeExact.isUserInteractionEnabled = false
